...
private:
    yarp::os::ConstString proc;
    yarp::os::ConstString part;
    bool data;
    bool filterData;
    bool chunked;
    ...
    yarp::os::ConstString format;
    yarp::os::ConstString outer;
public:
...
private:
    yarp::os::ConstString url, input, prefix;
    bool urlDone;
    bool expectPost;
    int contentLength;
    yarp::os::Property prop;
